...
struct RootViewFactory {
	...
	func makeSearchStylesDemoPage() -> some View {
        ...
        return SearchDemoView(navigatorViewModel: navigatorViewModel, searchViewModel: searchViewModel, viewFactory: self.makeDemoPageComponentsFactory(mapFactory: mapFactory))
	}
	...
	func makeDemoPageComponentsFactory(mapFactory: IMapFactory) -> DemoPageComponentsFactory {
    ...
    func makeMapFactory(mapOptions: MapOptions = .default) -> IMapFactory {
